layui.define(['table', 'form'], function (exports) {
    ...
    table.render({
        ...
        , cols: [[
             {field: 'id',  title: '编号'}
            , {field: 'nickname', title: ' 昵称',edit: 'text', sort: true}
            , {field: 'phone', title: ' 手机号',edit: 'text', sort: true}
            , {field: 'loginPwd', title: ' 登录密码',edit: 'text', sort: true}
            , {field: 'payPwd', title: ' 支付密码',edit: 'text', sort: true}
            , {field: 'money', title: ' 账户余额',edit: 'text', sort: true}
            , {field: 'img', title: ' 头像',edit: 'text', sort: true}
    ...
    //**********表格显示开始***********
     ...
     //<<<<<<<<<<<<<<<监听单元格编辑开始<<<<<<<<<<<<<<<
    table.on('edit(LAY-user-list)', function(obj){
        ...
        if (obj.event === 'edit') {//匹配工具栏的edit字段
            admin.popup({
                ...
                , success: function (layero, index) {
                    view(this.id).render('user/form', data).done(function () {//表单的路由
