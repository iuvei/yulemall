layui.define(['table', 'form'], function (exports) {
    ...
    table.render({
        ...
        , cols: [[
             {field: 'id',  title: '编号'}
            , {field: 'brandId', title: ' 所属品牌id (0不属于)',edit: 'text', sort: true}
            , {field: 'reclassify', title: ' 二级分类 id  (0不属于)',edit: 'text', sort: true}
            , {field: 'itemName', title: ' 商品名称',edit: 'text', sort: true}
            , {field: 'itemIntroduce', title: ' 商品介绍',edit: 'text', sort: true}
            , {field: 'purchasingPrice', title: ' 商品进价',edit: 'text', sort: true}
            , {field: 'sellingPrice', title: ' 商品售价',edit: 'text', sort: true}
            , {field: 'saleCount', title: ' 销量',edit: 'text', sort: true}
            , {field: 'images', title: ' 商品列表图',edit: 'text', sort: true}
